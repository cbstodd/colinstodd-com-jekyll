...
//   projectId: firerbaseConfig.projectId,
// });
...
const formMessage = firebase.firestore().ref(`contacts`);
...
function formSubmit(e) {
  ...
  if (validFormCheck() === true) {
    ...
    getId('warningMsg').innerHTML = `<p class="warning">Form is not valid, please check the required values. </p>`;
...
function sendMessage(name, isNotABot, email, reason, phone, message, uid, createdAt) {
